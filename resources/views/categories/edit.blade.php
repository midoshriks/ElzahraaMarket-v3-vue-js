                                ...
                                <div class="card card-info">
                                    ...
                                    <div class="card-body">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" style="height: 60px;" placeholder="category name" name="cat_name" value="{{$category->cat_name}}" >
                                        </div>
                                        ...
                                        <div class="input-group mb-3" >
                                            ...
                                            <input type="number" class="form-control" style="height: 60px;" placeholder="category short code" name="short_code" value="{{$category->short_code}}">
                                        </div>
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" style="height: 60px;" placeholder="category details" name="cat_details" value="{{$category->cat_details}}">
                                        </div>
